...
public class PrimaryTest {
    ...
    @Test(expected = AcnetStatusException.class)
    public void test_scaleFor_8bitAndPrimaryIndex52WhenLengthIsNot2() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor_8bitAndPrimaryIndex56() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor_8bitAndPrimaryIndex66() throws AcnetStatusException, SQLException {
    ...
    @Test(expected = AcnetStatusException.class)
    public void test_scaleFor_8bitAndPrimaryIndex68() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor_8bitAndPrimaryIndex72() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor_8bitAndPrimaryIndex74() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor8bitAndPrimaryIndex76() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor8bitAndPrimaryIndex82() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor8bitAndPrimaryIndex84() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor16bitAndPrimaryIndex66() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor16bitAndPrimaryIndex76() throws AcnetStatusException, SQLException {
    ...
    @Test(expected = AcnetStatusException.class)
    public void test_scaleFor16bitAndPrimaryIndex82DataLessThan0() throws AcnetStatusException, SQLException {
        Primary primary = getPrimary(2,82);
        primary.scale(-2);
    }
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_scaleFor16bitAndPrimaryIndex84() throws AcnetStatusException, SQLException {
    ...
    @Test(expected = AcnetStatusException.class)
    public void test_scaleForInvalidPrimaryTransformIndex() throws AcnetStatusException, SQLException {
    ...
    @Test (expected = AcnetStatusException.class)
    public void test_unscale_WhenLengthIs1AndPrimaryIndexIs0() throws AcnetStatusException, SQLException {
...
//    }
    ...
    @Test(expected = AcnetStatusException.class)
    public void test_unscale_WhenLengthIs2AndIndexIs54() throws AcnetStatusException, SQLException {
        Primary primary = getPrimary(2,54);
        primary.unscale(31);
    }

    @Test(expected = AcnetStatusException.class)
    public void test_unscale_WhenLengthIsNotEqualTo2AndPrimaryIndexIs56() throws AcnetStatusException, SQLException {
...
// In above code total we have 95 switch cases and one case might have 1-6 possible test cases.
//Primary index case 20: has 6 possible test cases
// case 1 - Input data length 8 bits, primary InputLength 1 and flt_data greater than 0
// case 2 - Input data length 8 bits, primary InputLength 1 and flt_data less than 0
// case 3 - Input data length 16 bits, primary InputLength 2 and flat_data greater than 0
// case 4 - Input data length 16 bits, primary InputLength 2 and flat_data less than 0
// case 5 - Input data length 32 bits, primary InputLength 4 and flat_data greater than 0
// case 6 - Input data length 32 bits, primary InputLength 4 and flat_data less than 0
