...
//        ResultSet commonResultSet = PowerMockito.mock(ResultSet.class);
//        when(commonResultSet.getInt("common_index")).thenReturn(index);
//        when(commonResultSet.getString("common_text")).thenReturn("ser");
//
//        DeviceInfo.ReadSetScaling.Common common = new DeviceInfo.ReadSetScaling.Common(commonResultSet);//added new constructor
