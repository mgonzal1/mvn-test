...
public class DPMAnalogAlarmScalingImplTest {
    ...
    public void test_enabled() throws AcnetStatusException, SQLException {
        ...
        Assert.assertFalse(analogAlarmScaling.enabled());
    }
